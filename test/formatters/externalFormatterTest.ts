...
describe("External Formatter", () => {
    ...
    before(function() {
        ...
        formatter = Lint.Formatters.getFormatterForName(TEST_MODULE);
    });
    it("formats failures", () => {
    ...
    it("throws on unresolvable module name", () => {
        assert.throws(() => {
            Lint.Formatters.getFormatterForName(TEST_FILE + "/__non-existent__");
        }, /^Cannot find module/);
    });
